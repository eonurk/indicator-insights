...
const TermsAndConditions: React.FC = () => {
	return (
		<>
			<SiteHeader />
			<Card className="container md:max-w-3xl">
				<CardHeader>
				...
				<CardContent>
					<div className="space-y-4 text-base">
						...
						<p>
							...
							<strong> Indicator Insights</strong> ("the Company", "we", "our",
							or "us") through our software platform, website, mobile
							application, or any other digital platform (collectively referred
							to as the "Services").
						</p>
						<p>
							1.2 By accessing or using our Services, you ("User" or "you")
						...
						<p>
							...
							Your continued use of the Services after the posting of the
						...
						<p>
							2.2 Our SaaS platform is accessible via subscription and may
							include various features such as real-time data analysis,
							customizable dashboards, and automated reporting tools. The
							specific features and scope of the Services are described on our
							website or in a separate agreement with you.
						</p>
						<p>
							2.3 Our Insights are provided for informational purposes only and
							do not constitute financial advice. Users should seek independent
							financial advice before making any investment decisions based on
							the Insights provided by our platform.
						</p>
						<p>
							2.4 We reserve the right to modify, suspend, or discontinue any
							part of our Services at any time with or without notice. We will
							endeavor to provide notice of any significant changes that may
						...
						<p>
							...
							your account information, including passwords, and for all
							activities that occur under your account.
						</p>
						<p>
							3.3 You agree to provide accurate, current, and complete
							information when creating an account or using our Services. You
							must update such information as necessary to keep it accurate and
							complete.
						</p>
						<p>
							3.4 You acknowledge that the financial Insights provided by the
							Company are based on data from third-party sources. The Company
						...
						<p>
							4.2 You may not reproduce, distribute, display, or otherwise use
							any of the intellectual property, including the Insights, without
							our prior written permission, except as expressly permitted under
							these Terms.
						</p>

						<h2 className="text-xl font-semibold">5. Fees and Payment</h2>
						<p>
							5.1 The fees for using our Services are as stated on our website
							or in a separate agreement with you. All fees are in [specify
							currency] and are exclusive of VAT unless otherwise stated.
						</p>
						<p>
							5.2 Payment must be made using the methods specified on our
							website. Failure to pay any fees may result in suspension or
						...
						<p>
							6.2 To the fullest extent permitted by law, Indicator Insights
							shall not be liable for any direct, indirect, incidental,
							consequential, or special damages arising out of or in connection
							with the use of our Services or the reliance on any financial
							Insights provided.
						</p>
						<p>
						...
						<p>
							...
							or the use of our Services shall be subject to the exclusive
