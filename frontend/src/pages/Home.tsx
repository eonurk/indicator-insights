...
export function Home({ user }: StockChartProps) {
	...
	const [selectedIndex] = useState("S&P 100");
		...
		<>
			...
			<div className="container mx-auto px-0">
				...
				>
					...
					>
						Get notified instantly when a specific indicator reaches a specific
						level
					</motion.span>
				</motion.div>
				...
				>
					...
					<motion.p
						...
						transition={{ duration: 0.5, delay: 0.4 }}
					>
						We trust the value we offer so much, that we offer a 7-day free
						trial. No credit card required. Cancel anytime. See for yourself!
					</motion.p>
