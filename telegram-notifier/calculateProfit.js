function calculateRMIProfit(prices, rmiData) {
...
function calculateMACDProfit(prices, macdData, signalData) {
	let capital = 100; // Initial capital
	let latestBuyPrice = null; // Initialize as null
	let latestSellPrice = null; // Initialize as null
	const buyPoints = [];
	const sellPoints = [];
...
function calculateRSIProfit(prices, rsiData) {
...
function calculateEMAProfit(prices, emaData) {
	let capital = 100;
	let latestBuyPrice = null;
	let latestSellPrice = null;
	const buyPoints = [];
...
function calculateSMAProfit(prices, smaData) {
	let capital = 100;
	let latestBuyPrice = null;
	let latestSellPrice = null;
	const buyPoints = [];
...
function calculateBollingerBandsProfit(prices, upperBand, lowerBand) {
	let capital = 100;
	let latestBuyPrice = null;
	let latestSellPrice = null;
	const buyPoints = [];
